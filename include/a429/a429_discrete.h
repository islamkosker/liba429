...
uint32_t a429_get_discrete_field(uint32_t word, uint8_t start_bit, uint8_t bit_width);

void a429_set_discrete_field(uint32_t *word, uint8_t start_bit, uint8_t bit_width, uint32_t value);
